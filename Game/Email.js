...
export class Email {
	...
	determineSource(phish_emails, real_emails){
		...
		if (rannum == 6/*this.phish == false*/){
			...
			var quest_num = 9;/*Math.floor(Math.random() * 12) + 1; */
			...
			case 8:
				...
				this.context = "The owner of a popular Instagram boutique is letting you know about a huge sale they are hosting and is encouraging"
                    + " you to consider shopping with them.";
            ...
            case 9:
                ...
                var rec_labels = ["UrbanHitz","CoolCatz","RadSoundz","RealTunez","TotalHarmoniez"];
